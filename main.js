...
const snackPalitosPanceta = new Producto (8858223012377, "Snack palitos sabor panceta ahumada 60 gr", 20230913, 3, "Snacks");
const snackPalitosPicante = new Producto (8858283008479, "Snack palitos sabor picante 60 gr", 20230913, 3, "Snacks");
const caramelosBerry = new Producto (4710035230230, "Caramelos masticables Hi-Chew sabor frutos rojos 110 gr", 20230601, 3, "Golosinas");
const lataCaramelos = new Producto (4901630002531, "Lata de caramelos Tumba de Luciérnagas Sakura Drops", 20240911, 3, "Golosinas");
...
function menu(){
    let opcion = parseInt(prompt("Ingrese una opción: 1)Agregar productos nuevos 2)Modificar stock 3)Consultar producto 4)Eliminar producto 5)Salir"));
    return opcion;
};
...
function agregarProductos(){
    ...
    let fecha = prompt("Ingrese la fecha de vencimiento del producto (aaaammdd)");
